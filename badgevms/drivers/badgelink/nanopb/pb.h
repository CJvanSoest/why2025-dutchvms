...
struct pb_msgdesc_s {
    uint32_t const            *field_info;
    pb_msgdesc_t const *const *submsg_info;
    pb_byte_t const           *default_value;

    bool (*field_callback)(pb_istream_t *istream, pb_ostream_t *ostream, pb_field_iter_t const *field);
...
struct pb_field_iter_s {
    pb_msgdesc_t const *descriptor; /* Pointer to message descriptor constant */
    ...
    pb_msgdesc_t const *submsg_desc; /* For submessage fields, pointer to field descriptor for the submessage. */
};
...
struct pb_callback_s {
     ...
     */
    union {
        bool (*decode)(pb_istream_t *stream, pb_field_t const *field, void **arg);
        bool (*encode)(pb_ostream_t *stream, pb_field_t const *field, void *const *arg);
    } funcs;
...
extern bool pb_default_field_callback(pb_istream_t *istream, pb_ostream_t *ostream, pb_field_t const *field);
...
struct pb_extension_type_s {
     ...
     * Set to NULL for default handler.
     */
    bool (*encode)(pb_ostream_t *stream, pb_extension_t const *extension);
...
struct pb_extension_s {
    ...
    pb_extension_type_t const *type;
...
#define PB_FIELDINFO_ASSERT_1(tag, type, data_offset, data_size, size_offset, array_size)                              \
    PB_STATIC_ASSERT(                                                                                                  \
        PB_FITS(tag, 6) && PB_FITS(data_offset, 8) && PB_FITS(size_offset, 4) && PB_FITS(data_size, 4) &&              \
...
#define PB_FIELDINFO_ASSERT_2(tag, type, data_offset, data_size, size_offset, array_size)                              \
    PB_STATIC_ASSERT(                                                                                                  \
        PB_FITS(tag, 10) && PB_FITS(data_offset, 16) && PB_FITS(size_offset, 4) && PB_FITS(data_size, 12) &&           \
...
#define PB_FIELDINFO_ASSERT_4(tag, type, data_offset, data_size, size_offset, array_size)                              \
    PB_STATIC_ASSERT(                                                                                                  \
        PB_FITS(tag, 16) && PB_FITS(data_offset, 16) && PB_FITS((int_least8_t)size_offset, 8) &&                       \
...
#define PB_FIELDINFO_ASSERT_4(tag, type, data_offset, data_size, size_offset, array_size)                              \
    PB_STATIC_ASSERT(                                                                                                  \
        PB_FITS(tag, 30) && PB_FITS(data_offset, 31) && PB_FITS(size_offset, 8) && PB_FITS(data_size, 31) &&           \
