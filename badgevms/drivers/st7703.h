...
#define CUSTOM_INIT_CMDS()                                                                                             \
    {                                                                                                                  \
        {0xB9, (uint8_t[]){0xF1, 0x12, 0x83}, 3, 0}, {0xB1, (uint8_t[]){0x00, 0x00, 0x00, 0xDA, 0x80}, 5, 0},          \
            {0xB2, (uint8_t[]){0x3C, 0x02, 0x30}, 3, 0},                                                               \
            {0xB3, (uint8_t[]){0x10, 0x10, 0x28, 0x28, 0x03, 0xFF, 0x00, 0x00, 0x00, 0x00}, 10, 0},                    \
            {0xB4, (uint8_t[]){0x80}, 1, 0}, {0xB5, (uint8_t[]){0x0A, 0x0A}, 2, 0},                                    \
            {0xB6, (uint8_t[]){0x97, 0x97}, 2, 0}, {0xB8, (uint8_t[]){0x26, 0x22, 0xF0, 0x63}, 4, 0},                  \
            {0xBA,                                                                                                     \
             ...
             27,                                                                                                       \
             0},                                                                                                       \
            {0xBC, (uint8_t[]){0x47}, 1, 0}, {0xBF, (uint8_t[]){0x02, 0x11, 0x00}, 3, 0},                              \
            {0xC0, (uint8_t[]){0x73, 0x73, 0x50, 0x50, 0x00, 0x00, 0x12, 0x70, 0x00}, 9, 0},                           \
            ...
            {0xC8, (uint8_t[]){0x10, 0x40, 0x1E, 0x02}, 4, 0}, {0xCC, (uint8_t[]){0x0B}, 1, 0},                        \
            {0xE0,                                                                                                     \
            ...
            {0xE9,                                                                                                     \
             (uint8_t[]                                                                                                \
             ){0xC8, 0x10, 0x0A, 0x00, 0x00, 0x80, 0x81, 0x12, 0x31, 0x23, 0x4F, 0x86, 0xA0, 0x00, 0x47, 0x08,         \
            ...
            {0xEA,                                                                                                     \
             (uint8_t[]                                                                                                \
             ){0x97, 0x0C, 0x09, 0x09, 0x09, 0x78, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x9F, 0x31, 0x8B, 0xA8,         \
             ...
             61,                                                                                                       \
             0},                                                                                                       \
            {0xEF, (uint8_t[]){0xFF, 0xFF, 0x01}, 3, 0}, {0x11, (uint8_t[]){}, 0, 250}, {0x29, (uint8_t[]){}, 0, 50},  \
    }
